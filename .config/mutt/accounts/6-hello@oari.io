...
# muttrc file for account hello@oari.io
set realname = "Oari"
set from = "hello@oari.io"
set status_format = "hello@oari.io"
set sendmail = "msmtp -a hello@oari.io"
alias me  <hello@oari.io>
set folder = "~/.local/share/mail/6-hello@oari.io"
set header_cache = ~/.cache/mutt-wizard/hello@oari.io/headers
set message_cachedir = ~/.cache/mutt-wizard/hello@oari.io/bodies
...
macro index o "<shell-escape>mw -y hello@oari.io<enter>" "run mbsync to sync hello@oari.io"
